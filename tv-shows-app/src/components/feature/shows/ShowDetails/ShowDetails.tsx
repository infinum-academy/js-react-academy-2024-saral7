...
export default function ShowDetails({show}: IShowItem) {
   return <Card variant="showDetails" width={["340px", "1054px"]}>
         <Image objectFit="cover" height="440" width={["340px", "1054px"]} src = {show.image_url ? show.image_url : '/images/placeholder.png'} />
            
         <CardBody flexDirection={["column", "row"]} alignItems={["start", "center"]}>
            <Flex direction="column" alignContent="start" alignItems="start">
               <Text fontWeight="bold" fontSize={[2, 1]} > {show.title} </Text>
            ...
            <Text width={["100%", "50%"]} fontSize={[5, 2]}> {show.description} </Text>
         </CardBody>
