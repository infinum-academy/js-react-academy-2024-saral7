...
import { Avatar, AvatarGroup, Button, Card, Flex, Menu, MenuButton, MenuIcon, MenuItem, MenuList, Text, useStyleConfig } from "@chakra-ui/react";
   ...
   const MenuComponent = <>
      <Menu>
         ...
         <MenuList minW={0} width="100px" fontSize={4} padding={1} >
            <MenuItem padding="0"><ReviewUpdate updatingReview={review}/></MenuItem>
            <MenuItem padding="0"><ReviewDeleteButton review={review}/></MenuItem>
         </MenuList>
      </Menu>
   </>
